...
; ! function (factory) {
    if (typeof require === 'function' && typeof exports === 'object' && typeof module === 'object') {
        ...
        factory(window['H'] = {
            ...
            openFrameGroupNavOrFootHeight: function (callback, groupName, frames, index, headerSelector, footerSelector, parentHeaderHeight, parentFooterHeight, options) {
                var that = this;
                var footerOffset = that.offset(footerSelector);
                ...
                that.fixStatusBar(function (offset) {
                    ...
                    options.rect = {
                        x: 0,
                        y: offset.h + parentHeaderHeight,
                        h: that.winHeight - offset.h - footerOffset.h - parentHeaderHeight - parentFooterHeight,
                        w: that.winWidth
                    };
                    that.openFrameGroup(callback, groupName, frames, index, options);
                }, headerSelector);
